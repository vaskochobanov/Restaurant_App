...
public class AppSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests().antMatchers("/js/**", "/css/**", "/img/**").permitAll()
                ...
                .antMatchers("/api/close-order", "/api/waiter-home/**").hasRole("WAITER")
                ...
                .antMatchers("/api/waiter-menu").hasAnyRole("WAITER", "CUSTOMER")
                .antMatchers("/api/drinks").hasRole("BARMAN")
                .antMatchers("/api/salads").hasRole("STARTERS")
                .antMatchers("/api/main-dish").hasRole("CHEF")
                .antMatchers("/api/desserts").hasRole("BAKER")
                .antMatchers("/api/prep/**").hasAnyRole("BARMAN", "STARTERS", "CHEF", "BAKER")
